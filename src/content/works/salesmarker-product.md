...
description: "1人目のデザイナーとして参画し、デザインシステム整備と高速な機能開発を両立。UX設計から実装調整まで横断してプロダクト成長に貢献しました。同時に、採用や組織づくりを進め、会社全体でのデザイナーの体制を構築しました。"
...
毎月拡大する会社で必要となるデザインを作りながら、正社員・業務委託の採用を、自らのリファラルで数人に参画してもらうなどしつつ進めました。
